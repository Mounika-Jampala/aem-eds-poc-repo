...
## Environments
- Preview: https://main--aem-eds-poc-repo--Mounika-Jampala.aem.page/
- Live: https://main--aem-eds-poc-repo--Mounika-Jampala.aem.live/
...
1. Open the `aem-eds-poc-repo` directory in your favorite IDE and start coding :)
